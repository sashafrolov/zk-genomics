...
use crate::alignment::verifier_input_for_basicalignment;
...
pub fn create_verifier_input(compute: ComputeType, aux_input: String, pfcurve: &PfCurve) -> HashMap<String, Value> {
    ...
    let result = match compute {
        ...
        ComputeType::BasicAlignment => {
            match pfcurve {
                PfCurve::Curve25519 => verifier_input_for_basicalignment(&ARC_MOD_CURVE25519),
                PfCurve::T256 => verifier_input_for_basicalignment(&ARC_MOD_T256),
                PfCurve::T25519 => verifier_input_for_basicalignment(&ARC_MOD_T25519),
            }
        },
    };
    result
